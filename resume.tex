...
\resumeItem{Implemented the software architecture to parse the input code into an Abstract Syntax Tree, as well as to check the input code for correctness and type safety and to infer unspecified type definitions}
