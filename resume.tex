...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{Completed courses in Introduction to Statistics and Advanced Statistics}
    \resumeItemListEnd
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Built a front-end which allows users to interact with the Wiles interpreter online as well as locally, including a syntax and error highlighter, developed using TypeScript, React, CSS and Next.js}
            ...
            \resumeItem{Deployed the application online using Amazon Web Services, using Unix Shell scripts to automate all steps the building, linking and deploying procedure}
