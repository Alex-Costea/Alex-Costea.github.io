...
\begin{center}
    ...
    \small Bucharest, Romania $|$ \href{mailto:alex@costea.in}{\underline{alex@costea.in}} $|$ 
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Lead the development of an internal Hardware Sourcing app, built on top of SAP Commerce Cloud using Java and Spring, that is poised to make the tracking of resources more efficient and reduce costs significantly.}
